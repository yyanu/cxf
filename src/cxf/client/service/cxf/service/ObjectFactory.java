 ...
 * generated in the cxf.client.service.cxf.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHello_QNAME = new QName("service.cxf.service.client.cxf", "sayHello");
    private final static QName _SayHelloResponse_QNAME = new QName("service.cxf.service.client.cxf", "sayHelloResponse");
    private final static QName _Upload_QNAME = new QName("service.cxf.service.client.cxf", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("service.cxf.service.client.cxf", "downloadResponse");
    private final static QName _UploadResponse_QNAME = new QName("service.cxf.service.client.cxf", "uploadResponse");
    private final static QName _Download_QNAME = new QName("service.cxf.service.client.cxf", "download");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cxf.client.service.cxf.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "service.cxf.service.client.cxf", name = "sayHello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "service.cxf.service.client.cxf", name = "sayHelloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "service.cxf.service.client.cxf", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "service.cxf.service.client.cxf", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "service.cxf.service.client.cxf", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "service.cxf.service.client.cxf", name = "download")
